<template>
  <div>
    <form>
      Name: <input data-test="new_channel" v-model="newChannel" type="text" placeholder="Introduïu un nom">
    ...
    <ul>
      <li v-for="channel in channels" :key="channel.id">
        <input v-if="editing === channel.id" type="text" v-model="newValue" @blur="update(channel)" :data-test="'new_value_' + channel.id">
